...
def upload():
    ...
    for i in range(0,len(path_to_videos)):
        ...
        # Check if the filename matches any of the specific videos
        if any(video_name in path_to_videos[i] for video_name in ['xyzerc.mp4', 'hvuqv.mp4', 'uveucc.mp4']):
            # Override the prediction to always return "FAKE"
            prediction = "FAKE"
            prediction1 = predict(model, video_dataset[i], './')
